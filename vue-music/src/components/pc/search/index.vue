...
<script>
const Star = () => import('components/pc/star')
const SearchInput = () => import('components/pc/input')
const SongList = () => import('components/pc/song-list')
const SongSheet = () => import('components/pc/songsheet')
const Singer = () => import('components/pc/singer')
const Album = () => import('components/pc/album')
const Error = () => import('components/pc/error')
export default {
  data(){
    return{
